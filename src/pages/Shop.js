    ...
    const fetchFilters = async () => {
      try {
        const [brandRes, categoryRes] = await Promise.all([
          axios.get("https://www.gsienterprises.com/api/filters/brands",{withCredentials:true}),
          axios.get("https://www.gsienterprises.com/api/filters/categories",{withCredentials:true}),
        ]);
    ...
    const fetchProducts = async () => {
      if (location.state?.searchResults) {
        ...
        try {
          ...
          const res = await axios.get("https://www.gsienterprises.com/api/getproducts/products",{withCredentials:true}, {
            params: {
              brands: brandQuery,
    ...
    <div className="bg-gradient-to-br from-purple-300 via-pink-300 to-yellow-300 min-h-screen py-10">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          {!isMobile && (
            <aside className="md:w-1/4 max-h-[80vh] bg-gradient-to-br from-gray-800 via-gray-900 to-black p-6 rounded-xl shadow-lg sticky top-6 text-white">
