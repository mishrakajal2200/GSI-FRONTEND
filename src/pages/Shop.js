...
//       </div>
//       {/* 🟢 This span toggles visibility only */}
//       <span
//         className="cursor-pointer text-purple-300 hover:text-purple-500 text-sm"
...
//     {/* Show subcategories only if open */}
//     {/* {brand.subcategories.length > 0 && openBrand === brand.name && (
//       <ul className="ml-4 space-y-1 mt-1">
//         {brand.subcategories.map((subcategory, subIndex) => (
//   <li key={subcategory + subIndex} className="flex items-center">
//     <input
//       type="checkbox"
//       className="mr-2 accent-purple-500 h-4 w-4"
//       onChange={() => handleBrandChange(subcategory)}
//       checked={selectedBrands.includes(subcategory)}
//     />
