...
const handleCODPayment = async () => {
  ...
  try {
    const res = await fetch("https://www.gsienterprises.com/api/payment/place-order",{withCredentials:true} ,{
      method: "POST",
      headers: {
...
const handlePayment = async () => {
  try {
    const res = await fetch("https://www.gsienterprises.com/api/payment/create-order",{withCredentials:true}, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
