...
//   return (
//     <Link to={`/shop?category=${productCategory}`}>
//     <div className="group relative h-64 rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-xl transition-all duration-300">
//       {/* Product Image */}
